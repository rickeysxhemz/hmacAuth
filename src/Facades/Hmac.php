 ...
 * @method static array generateCredentials(int $createdBy, string $environment = 'testing', ?CarbonInterface $expiresAt = null, int|string|null $tenantId = null)
 * @method static array rotateSecret(ApiCredential $credential, int $graceDays = 7)
